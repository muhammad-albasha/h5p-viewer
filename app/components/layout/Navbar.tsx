...
const Navbar = () => {
  ...
  const increaseFontSize = () => {
    document.documentElement.style.fontSize = 'calc(var(--font-size, 1rem) * 1.1)';
    document.documentElement.style.setProperty('--font-size', 
      `${parseFloat(getComputedStyle(document.documentElement).fontSize) * 1.1 / 16}rem`);
  };

  const decreaseFontSize = () => {
    document.documentElement.style.fontSize = 'calc(var(--font-size, 1rem) * 0.9)';
    document.documentElement.style.setProperty('--font-size', 
      `${parseFloat(getComputedStyle(document.documentElement).fontSize) * 0.9 / 16}rem`);
  };
