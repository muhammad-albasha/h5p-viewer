...
export default function Footer() {
  return (
    <footer className="bg-primary text-white p-10 border-t border-white">
      <div className="container-fluid mx-auto ">
        {/* Footer Columns Grid */}{" "}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
          <div className="flex flex-col space-y-2">
            <span className="footer-title text-lg font-semibold mb-2">
              H5P-Viewer
            </span>
          ...
          <div className="flex flex-col space-y-2">
            ...
            <a href="/easy-language" className="link link-hover text-sm">
              Leichte Sprache
            </a>
          </div>
          <div className="flex flex-col space-y-2">
            ...
            <a href="/h5p" className="link link-hover text-sm">
              Alle Inhalte
            </a>
            <a href="/bereiche" className="link link-hover text-sm">
              Bereiche
            </a>
          </div>
          <div className="flex flex-col space-y-2">
            ...
            <a href="/imprint" className="link link-hover text-sm">
              Impressum
            </a>
            <a href="/privacy" className="link link-hover text-sm">
              Datenschutz
            </a>
            <a href="/copyright" className="link link-hover text-sm">
              Urheberrecht
            </a>
          </div>
        </div>
