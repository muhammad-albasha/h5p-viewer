...
const BereichOverview = () => {
        ...
        if (contentResponse.ok) {
          ...
          allContent.forEach((item: any) => {
            if (item.subject_area?.slug) {
              counts[item.subject_area.slug] =
                (counts[item.subject_area.slug] || 0) + 1;
            }
          });
  ...
  const totalContent = Object.values(contentCounts).reduce(
    (sum, count) => sum + count,
    0
  );
  return (
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="text-white">
              ...
              <p className="text-blue-100 text-lg max-w-2xl">
                Entdecken Sie H5P-Lerninhalte organisiert nach Bereichen für
                optimales Lernen
              </p>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20 p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Wählen Sie einen Bereich, um die verfügbaren H5P-Lerninhalte
                    zu entdecken
                  </p>
                </div>
              </div>{" "}
                      ...
                      >
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl overflow-hidden border border-white/20 transition-all duration-300 hover:scale-105 group">
                          ...
                          <div className="p-6">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                              <div
                                className={`p-3 bg-gradient-to-r ${gradientClass} rounded-xl text-white`}
                              >
                                <svg
                                  className="w-6 h-6"
                                  fill="none"
                              ...
                              <h3 className="text-xl font-bold text-gray-900 group-hover: transition-colors">
                                {area.name}
                              </h3>
                            </div>
                            ...
                            <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                              Entdecken Sie alle verfügbaren H5P-Lerninhalte in
                              diesem Bereich
                            </p>
...
export default BereichOverview;
