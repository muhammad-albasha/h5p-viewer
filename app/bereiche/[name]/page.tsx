          ...
          {isLoading ? (
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
              <div className="flex flex-col items-center justify-center p-12">
                ...
                <p className="text-gray-500 text-sm mt-1">
                  Für diesen Bereich sind noch keine H5P-Inhalte verfügbar.
                </p>
                <Link
                  href={withBasePath("/bereiche")}
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-600">
                          {filteredContent.length} von {content.length} Inhalten
                          gefunden
                        </p>
                ...
                {filteredContent.length === 0 && content.length > 0 ? (
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
                    <div className="flex flex-col items-center justify-center p-12">
                      ...
                      <p className="text-gray-500 text-sm mt-1">
                        Keine Inhalte entsprechen den aktuellen Filterkriterien.
                      </p>
                      <button
                        onClick={() => {
                          setSearchQuery("");
