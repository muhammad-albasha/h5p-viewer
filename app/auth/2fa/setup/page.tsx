    ...
    try {
      ...
      setError(
        error.message === "Invalid token"
          ...
          : "Fehler beim Aktivieren der 2FA"
      );
    } finally {
      setIsLoading(false);
    }
              ...
              <div className="space-y-6">
                <div className="alert alert-info">
                  ...
                  <div>
                    ...
                    <div className="text-xs">
                      2FA fügt eine zusätzliche Sicherheitsebene zu Ihrem Konto
                      hinzu. Sie benötigen sowohl Ihr Passwort als auch einen
                      Code von Ihrer Authenticator-App.
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm opacity-70">
                    Falls noch nicht geschehen, installieren Sie eine
                ...
                <div className="space-y-4">
                  ...
                  <div className="alert alert-warning">
                    ...
                    <div>
                      ...
                      <div className="text-xs">
                        Laden Sie Ihre Backup-Codes herunter und bewahren Sie
                        sie sicher auf. Sie können diese verwenden, falls Sie
            ...
            {step === "complete" && (
              <div className="space-y-6 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-70 mt-2">
                    Ihr Konto ist jetzt mit Zwei-Faktor-Authentifizierung
                    geschützt.
                  </p>
                </div>
                ...
                <div className="alert alert-success">
                  ...
                  <div>
                    ...
                    <div className="text-xs">
                      Bei Ihrer nächsten Anmeldung werden Sie nach einem Code
                      aus Ihrer Authenticator-App gefragt.
                    </div>
                  </div>
                </div>
