...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (easyLanguage !== undefined) {
      await pageSettingsService.upsert('easy_language', easyLanguage, 'Leichte Sprache Seiteninhalt');
    }
      if (about !== undefined) {
      await pageSettingsService.upsert('about_us', about, 'Über uns Seiteninhalt');
    }
