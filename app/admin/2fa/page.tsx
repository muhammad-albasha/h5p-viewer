...
export default function TwoFactorManagementPage() {
  ...
  const disableTwoFactor = async () => {
    if (
      !confirm(
        "Sind Sie sicher, dass Sie die Zwei-Faktor-Authentifizierung deaktivieren möchten? Dies verringert die Sicherheit Ihres Kontos."
      )
    ) {
      return;
    }
    ...
    try {
      ...
      setError(
        "Fehler beim Deaktivieren der 2FA. Bitte versuchen Sie es erneut."
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="flex justify-center items-center h-screen">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600 mt-4">
              2FA-Einstellungen werden geladen...
            </p>
          </div>
        </div>
      </>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
                    ...
                    <div className="p-2 bg-white/20 rounded-lg">
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth="2"
                          d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.856-.833-2.626 0L3.228 16.5c-.77.833.192 2.5 1.732 2.5z"
                        />
                      </svg>
                    </div>
                    <h2 className="text-xl font-bold">
                      Empfehlung: 2FA aktivieren
                    </h2>
                  </div>
                ...
                <div className="p-6">
                  <p className="text-gray-700 mb-4">
                    ...
                    Sicherheitsebene zu Ihrem Konto hinzu und schützt vor
                    unbefugtem Zugriff.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
                ...
                <div className="p-6">
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-gray-700">
                        Zusätzlicher Schutz neben Ihrem Passwort
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <span className="text-gray-700">
                        Verwendung einer Authenticator-App auf Ihrem Smartphone
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <span className="text-gray-700">
                        Zeitbasierte Codes, die alle 30 Sekunden wechseln
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  ...
                  <div className="mt-6">
                    <Link
                      href="/auth/2fa/setup"
                      className="w-full bg-gradient-to-r from-primary to-secondary hover: text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="none"
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
                ...
                <div className="p-6">
                  <p className="text-gray-700 mb-4">
                    ...
                    Bei jeder Anmeldung wird ein Code von Ihrer
                    Authenticator-App angefordert.
                  </p>
                </div>
              </div>
                ...
                <div className="p-6">
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <span className="text-gray-700">
                        Stellen Sie sicher, dass Ihre Authenticator-App
                        gesichert ist
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <span className="text-gray-700">
                        Bei Verlust Ihres Geräts können Sie Backup-Codes
                        verwenden
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <span className="text-gray-700">
                        Kontaktieren Sie den Administrator bei Problemen
                      </span>
                    </li>
                  </ul>
