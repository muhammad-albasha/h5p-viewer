...
export default function LegalPagesAdmin() {
  ...
  const tabs = [
    {
      id: "imprint" as LegalPageType,
      label: "Impressum",
      description: "Rechtliche Informationen über die Website",
      icon: "📋",
    },
    {
      id: "privacy" as LegalPageType,
      label: "Datenschutz",
      description: "Datenschutzerklärung und Cookie-Richtlinien",
      icon: "🔒",
    },
    {
      id: "copyright" as LegalPageType,
      label: "Urheberrecht",
      description: "Urheberrechtsbestimmungen und Lizenzen",
      icon: "©️",
    },
    {
      id: "easyLanguage" as LegalPageType,
      label: "Leichte Sprache",
      description: "Inhalte in leichter, verständlicher Sprache",
      icon: "📖",
    },
    {
      id: "about" as LegalPageType,
      label: "Über uns",
      description: "Informationen über das Team und die Mission",
      icon: "👥",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-primary via-secondary to-primary py-16">
        ...
        <div className="relative container-fluid mx-auto  px-4">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-white/80 text-lg">
                Bearbeiten Sie Impressum, Datenschutz, Urheberrecht, Leichte
                Sprache und Über uns mit dem modernen Rich-Text-Editor
              </p>
            </div>
                ...
                <div>
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    <RichTextEditor
                      ...
                      placeholder={`Geben Sie hier den Inhalt für die ${
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm">
                    So wird Ihre{" "}
                    {tabs.find((tab) => tab.id === activeTab)?.label}-Seite
                    aussehen
                  </p>
                </div>
              </div>
              ...
              <div className="prose max-w-none">
                {content[activeTab] ? (
                  ...
                  <div className="bg-gray-50 rounded-xl p-6 border border-gray-200 text-gray-500 italic text-center">
                    ...
                    <p>
                      Kein Inhalt vorhanden. Fügen Sie oben Inhalt hinzu, um
                      eine Vorschau zu sehen.
                    </p>
                  </div>
                )}
              </div>
